...
de.paths <-  readRDS("reduced_pathways_output/MSBB/MSBB_PHG_ADvsControl _DEP_AD_vs_Control.RDS")
...
sel.paths <- read.csv("tables/shared_pathways_reduced/45vs47_Mayo_MSBB_ROSMAP_2.csv")
...
PathResiduals  <- readRDS("reduced_pathways_output/ROSMAP/ROSMAP_DLPFC_ADvsControl _DEP_AD_vs_Control.RDS")
...
tcx_residuals <- readRDS("reduced_pathways_output/MAYO/Mayo_ADvsControl _DEP_AD_vs_CONTROL.RDS")
...
cell_residuals <- readRDS("reduced_pathways_output/I45FvsI47F/I45FvsI47F _DEP_AD_vs_Control.RDS")
...
cairo_pdf(file = paste0("figures/S03_heatmap_all.pdf"),
