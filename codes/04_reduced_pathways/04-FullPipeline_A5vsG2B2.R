...
out.dir = 'reduced_pathways_output/A5vsG2B2/'
...
de.paths <- PanomiR::differentialPathwayAnalysis(geneCounts = genes.counts2,
                                        ...
                                        contrastConds = "ConditionA5-ConditionG2B2")
